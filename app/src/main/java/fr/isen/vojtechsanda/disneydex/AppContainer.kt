...
import fr.isen.vojtechsanda.disneydex.domain.usecase.movie.ObserveMoviesUseCase
...
object AppContainer {
    ...
    val observeMoviesUseCase: ObserveMoviesUseCase by lazy {
        ObserveMoviesUseCase(movieRepository)
    }
